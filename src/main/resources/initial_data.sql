INSERT INTO user (username, password, firstName, lastName, email, address) VALUES ('catalin','pass123','Catalin','Narita','catalin.ioan.narita@gmail.com','Bucium');
INSERT INTO user (username, password, firstName, lastName, email, address) VALUES ('olimpiu','pass123','Olimpiu','Stefan','olimpiu.stefan@gmail.com','Brad');
INSERT INTO user (username, password, firstName, lastName, email, address) VALUES ('calin','pass123','Calin','Cotet','calin.cotet@gmail.com','Abrud');
...
INSERT INTO monitor_spec(aspect_ratio, colour, diagonal, guarantee, producer, resolution) VALUES ('16:9','BLACK',23,'_24','LG','1920 x 1080');
...
INSERT INTO product (name, category, price, product_spec_id) VALUES ('Monitor LED BenQ Gaming Zowie XL2411','MONITOR','1249.99',1);
INSERT INTO product (name, category, price, product_spec_id) VALUES ('Monitor LED LG 23MP68VQ-P','MONITOR','679.99',2);
INSERT INTO product (name, category, price, product_spec_id) VALUES ('Ultrabook ASUS 15.6'''' ZenBook UX530UQ, FHD','LAPTOP','5098.99',3);
INSERT INTO product (name, category, price, product_spec_id) VALUES ('Notebook / Laptop Lenovo Gaming 15.6'''' Legion Y520, FHD IPS','LAPTOP','3898.99',4);
INSERT INTO product (name, category, price, product_spec_id) VALUES ('Smartphone Google Pixel XL','SMARTPHONE','2798.99',5);
